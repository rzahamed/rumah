{{--
    Practice-area icon "IP & Innovation Protection" — transcribed from
    resources/images/icons/ip.svg (path data verbatim; Paper's selected-tab
    export, hence its 24×24 viewBox). Stroke follows the tab's text colour, so
    it is white on the selected tab and dark anywhere else. Decorative — the
    tab label names it.
--}}
<svg
